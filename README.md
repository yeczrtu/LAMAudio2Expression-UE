...
ニューラルモデルはGitに含みません。[LAMAudio2Expression-UE-Demo](https://github.com/yeczrtu/LAMAudio2Expression-UE-Demo) がこのプラグインをサブモジュールとして使用するデモ・検証用プロジェクトです。
...
キャラクター、JVNV音声6件、マップ、操作UIは [LAMAudio2Expression-UE-Demo](https://github.com/yeczrtu/LAMAudio2Expression-UE-Demo) の `Content/LAMFaceDemo`、`Resources/Demo`、`Source/LAMDemo` に置いています。このプラグインにはデモ素材やCC BY-SAの音声を含めません。
