...
No FLAME meshes, Gaussian avatar renderer, character meshes, demo audio or audiovisual demo materials are included in this plugin. The separate LAMAudio2Expression-UE-Demo demo repository manages those assets and their licenses: https://github.com/yeczrtu/LAMAudio2Expression-UE-Demo . Test fixtures are generated by that repository's Tools/make_fixtures.py.
